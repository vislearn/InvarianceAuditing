...
def batch_wrap(fn: Callable) -> Callable:
    ...
    def deep_unsqueeze(arg):
        ...
        # Anything else has no batch dimension to add -- a float, a bool, None.
        # Falling off the end here returned None instead, so a scalar argument
        # was silently replaced rather than passed through.
        return arg
